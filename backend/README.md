...
## Project Structure
    ...
    ├── athletedirector_38768  # Django project configurations
...
1. Clone this repo and `cd athletedirector_38768`
...
2. Clone this repo and `cd athletedirector_38768`
